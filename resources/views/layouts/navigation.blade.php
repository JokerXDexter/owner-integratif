<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a
                        href="{{ Auth::user()->usertype == 'admin' ? route('admin.dashboard') : (Auth::user()->usertype == 'owner' ? route('owner.dashboard') : route('dashboard')) }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="Auth::user()->usertype == 'admin'
                        ...
                        : (Auth::user()->usertype == 'owner'
                            ...
                            : route('dashboard'))" :active="Auth::user()->usertype == 'admin'
                    ...
                    @if (Auth::user()->usertype == 'owner')
                        <x-nav-link href="{{ route('owner.dorm') }}" :active="request()->routeIs('owner.dorm')">
                            {{ __('Kelola Kost') }}
                        </x-nav-link>
                    @endif
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- Owner Links --}}
            @if (Auth::user()->usertype == 'owner')
                <x-responsive-nav-link href="kelola-kost" :active="request()->routeIs('owner.dorm')">
                    {{ __('Kelola Kost') }}
                </x-responsive-nav-link>
            @endif
